...
function RouteComponent() {
  ...
  return (
    <div className='min-h-screen bg-linear-to-b from-background to-muted/20 py-12 px-6'>
                ...
                <CardContent className='pt-6 space-y-6'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <Textarea
                      ...
                      required
                      className='min-h-[150px] bg-muted/20 focus-visible:ring-primary'
                    />
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div className='space-y-2'>
                      ...
                      <div className='flex gap-2'>
                        ...
                        >
                          <SelectTrigger className='w-[100px] bg-muted/20'>
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                    ...
                    <div className='space-y-2'>
                      ...
                      <Select
                        ...
                        required
                      >
                        <SelectTrigger id='arbiter' className='bg-muted/20'>
