            ...
            <Card className='border-primary/10 shadow-sm overflow-hidden'>
              ...
              <CardContent className='pt-6 space-y-6'>
                <div className='space-y-4'>
                  ...
                  <Tabs
                    value={paymentType}
                    onValueChange={(v) => setPaymentType(v as 'eth' | 'token')}
                    className='w-full'
                  >
                ...
                {sumMilestones !== Number(totalAmount) &&
                  totalAmount !== '' && (
                    <div className='flex items-center gap-2 p-3 rounded-lg bg-destructive/10 text-destructive text-sm font-medium animate-pulse'>
                      ...
                      Total milestones ({sumMilestones} {unit}) must equal total
                      budget ({totalAmount} {unit})
                    </div>
                  )}
              </CardContent>
            </Card>
          ...
          <div className='sticky top-8'>
            ...
            <div className='mt-8 p-6 rounded-2xl bg-primary/5 border border-primary/10 space-y-4'>
              ...
              <p className='text-sm text-muted-foreground leading-relaxed'>
                Breaking your project into 3-5 milestones helps build trust with
                freelancers and ensures steady progress.
              </p>
            </div>
          </div>
        </div>
